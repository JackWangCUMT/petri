...
namespace Statechart
{
	public class Document {
		public Document(string path) {
			...
			controller = new StateChartController(this);
		...
		public StateChartController Controller {
			get {
				return controller;
			}
		}
		...
		public void Restore()
		{
			...
			window.Drawing.EditedStateChart = null;
			Controller.EditedObject = null;

			var oldStateChart = stateChart;

			this.ResetID();
			try {
				if(path == "") {
					stateChart = new RootStateChart(this);
					int docID = 1;
					...
					stateChart = new RootStateChart(this, elem.Element("StateChart"));
					stateChart.Canonize();
			...
			Controller.StateChart = stateChart;
			window.Drawing.EditedStateChart = stateChart;
		...
		string path;
		MainWindow window;
		StateChartController controller;
		RootStateChart stateChart;
