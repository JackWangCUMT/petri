...
{
	public sealed class InnerStateChart : StateChart
	{
		public InnerStateChart(Document doc, StateChart parent, bool active, Cairo.PointD pos) : base(doc, parent, active, pos)
		{
			this.exitPoint = new ExitPoint(doc, this, new Cairo.PointD(300, 100));
			this.AddState(this.ExitPoint);
		}

		public InnerStateChart(Document doc, StateChart parent, XElement descriptor) : base(doc, parent, descriptor) {
		...
		public override void GenerateCpp(Cpp.Generator source, IDManager lastID) {
			...
			source += name + "->setAction(" + "make_callable_ptr([](){ return ResultatAction::ActionReussie; })" + ");";
