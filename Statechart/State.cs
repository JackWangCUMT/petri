...
namespace Statechart
{
	...
	{
		public State(Document doc, StateChart parent, bool active, int requiredTokens, Cairo.PointD pos) : base(doc, parent) {
		...
		public State(Document doc, StateChart parent, XElement descriptor) : base(doc, parent, descriptor) {
			this.transitionsBefore = new List<Transition>();
			this.transitionsAfter = new List<Transition>();
	...
	public abstract class NonRootState : State {
		public NonRootState(Document doc, StateChart parent, bool active, Cairo.PointD pos) : base(doc, parent, active, 0, pos) {}

		public NonRootState(Document doc, StateChart parent, XElement descriptor) : base(doc, parent, descriptor) {}
	}
}
