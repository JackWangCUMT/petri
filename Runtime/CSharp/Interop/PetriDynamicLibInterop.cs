...
namespace Petri.Runtime.Interop {
    ...
    public class PetriDynamicLib {
        ...
        [DllImport("PetriRuntime")]
        public static extern IntPtr PetriDynamicLib_createWithPtr(PtrCallableDel createPtr, PtrCallableDel createDebugPtr, StringCallableDel hashPtr, [MarshalAs(UnmanagedType.LPTStr)] string name, [MarshalAs(UnmanagedType.LPTStr)] string prefix, UInt16 port);
